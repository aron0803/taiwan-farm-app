...
REGISTRY = [
    ...
    # 第三十三批（新增：葉菜類/雜糧/花菜類，Google搜尋補充）
    ("yuyiganlan", "羽衣甘藍", "葉菜類", "collected"),
    ("yanmai", "燕麥", "雜糧", "collected"),
    ("chaoxianji", "朝鮮薊", "花菜類", "collected"),
    # 第三十四批（新增：花菜類/果菜類/花卉類，比對種苗商店 b/g/h 分類）
...
CROPS = [
    ...
    # 第三十三批（新增，資料來源多為政府機關官網或半官方推廣單位，非kmweb農業知識入口網）
    dict(crop_id="yuyiganlan", name="羽衣甘藍", category="葉菜類",
         region_north="桃園大溪有農友以友善有機農法栽種",
         region_central=None,
         region_south="花蓮紅香部落協同生態農場種植約兩分地",
         region_note="十字花科甘藍屬蔬菜，喜冷涼環境但栽培彈性大；資料來源為農產品銷售平台與種苗商農業技術頁面（非kmweb官方頁面），標記為qa等級；現今亦有業者以水耕技術達成周年生產不受季節限制。",
         season_months_north=M(3,4,9,10), season_months_central=M(3,4,9,10), season_months_south=M(3,4,9,10),
         season_label="春、秋兩季適合露地栽培，定植後約55天開始採收；水耕栽培可周年生產不受季節限制；行株距約45～50×35～45公分，定植後須澆足水"),
    dict(crop_id="yanmai", name="燕麥", category="雜糧",
         region_north=None, region_central=None, region_south="雲林縣為燕麥加工與相關農產品重要地區",
         region_note="台灣本土品種為國立台灣大學農藝系1979年（民國68年）選育之「燕麥台大選一號」；官方牧草主題館列有芻料燕麥生產評估資料，資料完整度佳；可作冬季芻料/綠肥使用，栽培簡易可不施肥料、不用農藥。",
         season_months_north=M(10,11,12), season_months_central=M(10,11,12), season_months_south=M(10,11,12),
         season_label="適合台灣冬季栽培，播種期為10月底至12月；台大選一號品種於9月中旬播種，約54天可抽穗"),
    dict(crop_id="chaoxianji", name="朝鮮薊", category="花菜類",
         region_north=None, region_central="台中市、南投縣山區有少量栽培（含梨山海拔2,000公尺試種）",
         region_south=None,
         region_note="菊科多年生草本，食用部位為未開花之花苞（西洋蔬菜之皇）；官方桃園區農業改良場資料明確列出栽培環境與生育週期，資料完整度佳；平地種植成功率極低（夏季幾乎無法生長），商業生產集中冷涼山區，臺灣平地產季僅4月。",
         season_months_north=None, season_months_central=M(8,9), season_months_south=None,
         season_label="喜全日照冷涼環境，日溫24℃、夜溫13℃下生長最好；農民通常於夏末（約8月）育苗，約一個月後（約9月）定植；經低溫春化作用後於春天抽梗開花，適當條件下可作多年生栽培；臺灣平地產季僅4月，山區（如梨山2,000公尺）品質更佳"),
    # 第三十四批（新增）
    dict(crop_id="baoziganlan", name="抱子甘藍", category="花菜類",
         region_north=None, region_central=None, region_south=None,
         region_note="別名球芽甘藍，十字花科蕓薹屬植物，原產地中海沿岸，食用部位為葉腋間形成的小型芽球；台灣有少量種植但主流資料多為中國大陸農業百科網站（非台灣官方來源），標記為qa等級；為強冷涼性作物，台灣涼季（約10月至翌年3月）栽培為宜，此處月份為涼季的合理區間推算，非原文精確月份。",
         season_months_north=M(10,11,12,1,2,3), season_months_central=M(10,11,12,1,2,3), season_months_south=M(10,11,12,1,2,3),
         season_label="喜冷涼氣候、耐寒性強，適合生長溫度12～20℃，芽球形成最適溫度7～18℃，台灣涼季栽培為宜（此為合理季節區間推算，非原文精確月份）；定植後約90～120天可逐批採收，台灣涼季通常約100±10天；標準種植密度45×60公分，土壤宜疏鬆排水良好，pH6.5～7.0"),
    dict(crop_id="jigua", name="櫛瓜", category="果菜類",
         region_north=None, region_central="南投仁愛鄉為主要產地，栽培面積約200多公頃，年產量約150～200公噸",
         region_south="台南亦為主要產地",
         region_note="又稱夏南瓜，為美洲南瓜（Cucurbita pepo）之栽培品種，19世紀後期於米蘭育成；官方農業知識入口網有留種資料，加上農傳媒等媒體報導提供播種期資訊，資料完整度佳；雖稱「夏南瓜」，但台灣因夏季過熱，實際以春、秋兩季栽培為宜。",
         season_months_north=M(9,10,11,12,1,2,3), season_months_central=M(9,10,11,12,1,2,3), season_months_south=M(9,10,11,12,1,2,3),
         season_label="台灣播種期為9月至翌年3月，播種後35～45天可採收第一條瓜，10月起至翌年4月為主要供應期；雖稱夏南瓜，但台灣夏季過熱不適合，實際以春、秋兩季栽培為宜，宜蘭亦有栽培"),
    dict(crop_id="mantianxing", name="滿天星", category="花卉類",
         region_north=None, region_central=None, region_south=None,
...
CULTIVATION = [
    ...
    # 羽衣甘藍 - 農產品銷售平台/種苗商技術頁面（非kmweb官方頁面）
    ("yuyiganlan", "適合季節與栽培方式", "春、秋兩季適合露地栽培，定植後約55天開始採收；現今亦有業者以水耕技術栽培，可周年生產不受季節限制", "直接跟農夫買（羽衣甘藍品種介紹）", "https://www.buydirectlyfromfarmers.tw/catalogue/kale-5nutrition_5394/", "qa", "2026-08-23"),
    ("yuyiganlan", "株距與定植", "行株距約45～50×35～45公分，定植後須澆足水；可自行培養EM菌調整土壤菌叢以增加抵抗病蟲害能力", "上下游新聞（超級蔬菜羽衣甘藍，台灣農場找得到）", "https://www.newsmarket.com.tw/blog/119444/", "qa", "2026-08-23"),
    ("yuyiganlan", "台灣栽培產地", "花蓮紅香部落協同生態農場種植約兩分地；桃園大溪有農友以友善有機農法栽種", "上下游新聞（超級蔬菜羽衣甘藍，台灣農場找得到）", "https://www.newsmarket.com.tw/blog/119444/", "qa", "2026-08-23"),

    # 燕麥 - 農業知識入口網 牧草主題館 / 台灣大紀元
    ("yanmai", "適合季節", "適合台灣冬季栽培，播種期為10月底至12月", "台灣大紀元（播下一分地種子 台灣燕麥現身）", "https://www.epochtimes.com.tw/n278682/播下一分地種子-台灣燕麥現身.html", "qa", "2026-08-23"),
    ("yanmai", "本土品種", "台灣本土品種為國立台灣大學農藝系1979年選育之「燕麥台大選一號」，於9月中旬播種，約54天可抽穗；可有機栽種不需施用農藥", "台灣大紀元（播下一分地種子 台灣燕麥現身）", "https://www.epochtimes.com.tw/n278682/播下一分地種子-台灣燕麥現身.html", "qa", "2026-08-23"),
    ("yanmai", "芻料生產", "台灣冬季芻料新選擇，可作為牧草/綠肥使用", "農業知識入口網（芻料燕麥生產評估）", "https://kmweb.moa.gov.tw/subject/subject.php?id=40948", "official", "2026-08-23"),

    # 朝鮮薊 - 桃園區農業改良場
    ("chaoxianji", "適合溫度與環境", "喜全日照冷涼環境，日溫24℃、夜溫13℃下生長最好；夏季幾乎無法生長，平地種植成功率極低", "桃園區農業改良場（認識西洋蔬菜之皇－朝鮮薊）", "https://www.tydares.gov.tw/theme_data.php?theme=prevention&id=236&print=Y", "official", "2026-08-23"),
    ("chaoxianji", "栽培週期", "農民通常於夏末育苗，約一個月後定植；經低溫春化作用後，春天抽梗開花；適當條件下可作多年生栽培", "桃園區農業改良場（認識西洋蔬菜之皇－朝鮮薊）", "https://www.tydares.gov.tw/theme_data.php?theme=prevention&id=236&print=Y", "official", "2026-08-23"),
    ("chaoxianji", "台灣栽培現況", "僅少數農民種植，多做機能性保健食品原料；平地產季僅4月；已有農友在台中梨山海拔2,000公尺地區試種，花苞可達400公克上品", "農傳媒（歐洲蔬菜之皇在地栽培 高山大尺寸朝鮮薊現正盛產）", "https://www.agriharvest.tw/archives/39274", "qa", "2026-08-23"),

    # 抱子甘藍 - 中文百科全書（非台灣官方來源，標記qa）
    ("baoziganlan", "適合溫度", "喜冷涼氣候、耐寒性強，適合生長溫度12～20℃，芽球形成最適溫度7～18℃", "中文百科全書（抱子甘藍）", "https://www.newton.com.tw/wiki/%E6%8A%B1%E5%AD%90%E7%94%98%E8%97%8D", "qa", "2026-08-23"),
    ("baoziganlan", "栽培週期與株距", "定植後約90～120天可逐批採收，台灣涼季通常約100±10天；標準種植密度45×60公分", "中文百科全書（抱子甘藍）", "https://www.newton.com.tw/wiki/%E6%8A%B1%E5%AD%90%E7%94%98%E8%97%8D", "qa", "2026-08-23"),
    ("baoziganlan", "土壤條件", "土壤宜疏鬆、排水良好之壤土，pH6.5～7.0", "中文百科全書（抱子甘藍）", "https://www.newton.com.tw/wiki/%E6%8A%B1%E5%AD%90%E7%94%98%E8%97%8D", "qa", "2026-08-23"),

    # 櫛瓜 - 農業知識入口網 / 農傳媒
    ("jigua", "適合季節", "台灣播種期為9月至翌年3月，播種後35～45天可採收第一條瓜，10月起至翌年4月為主要供應期", "農傳媒（長年深耕，櫛瓜新故鄉）", "https://www.agriharvest.tw/archives/121655/", "qa", "2026-08-23"),
    ("jigua", "栽培特性", "雖稱夏南瓜，但台灣因夏季過熱不適合，實際以春、秋兩季栽培為宜", "農傳媒（長年深耕，櫛瓜新故鄉）", "https://www.agriharvest.tw/archives/121655/", "qa", "2026-08-23"),
    ("jigua", "主要產地", "南投仁愛鄉栽培面積約200多公頃，年產量約150～200公噸，為主要產地；台南、宜蘭亦有栽培", "農傳媒（長年深耕，櫛瓜新故鄉）", "https://www.agriharvest.tw/archives/121655/", "qa", "2026-08-23"),
...
UNVERIFIED = [
    ...
    ("yuyiganlan", "本次資料來源均非kmweb農業知識入口網等一級政府機關頁面，而是農產品銷售平台與新聞媒體報導，標記為qa等級，需另行以官方（如各區農業改良場）資料交叉核實；土壤條件、施肥、病蟲害資料本次均未查得，需另行補齊。"),
    ("yanmai", "適合季節部分來源為新聞報導（qa等級），僅牧草主題館一筆為官方來源但未含具體播種月份，需另行以官方播種曆核實；土壤條件、株距、施肥、病蟲害資料本次均未查得，需另行補齊；燕麥主要作綠肥/牧草用途而非直接食用作物，之後在UI呈現時可補充說明其用途定位。"),
    ("chaoxianji", "本表season欄位僅中部（山區）有月份資料，北部、南部是否適合栽培尚待查證；栽培地點受海拔與氣候限制（平地夏季幾乎無法生長），與甜柿、蘋果等高冷地作物性質相近，「現在適合種」邏輯需額外考慮此限制；土壤條件、株距、施肥、病蟲害資料本次均未查得，需另行補齊；朝鮮薊在台灣栽培規模小眾，多作保健食品原料，之後在UI呈現時可補充說明其小眾定位。"),
